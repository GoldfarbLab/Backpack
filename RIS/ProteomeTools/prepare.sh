...
declare -a scripts=("convert_raw.bsub" "sage.bsub" "annotate.bsub" "deisotope.bsub" "NCE_align.bsub" "consolidate_NCEs.bsub" "pipeline2.sh" "update_NCEs.bsub" "chronologer.bsub" "split_indiv.bsub" "merge_ion_dict.bsub" "filter.bsub" "merge_xv.bsub" "create_aidata.bsub" "train.bsub" "msp2tsv.bsub" "interpolate.bsub" "quad_fit.bsub" "merge_quad.bsub" "train_array.bsub" "export2onnx.bsub" "reisotope_compare.bsub" "split_indiv_raw.bsub" "merge_xv_raw.bsub")
