...
# submit msp2tsv job
#jid_msp2tsv=$(get_jobid bsub < /scratch1/fs1/d.goldfarb/Backpack/ProteomeTools/Part1/01625b_GA1-TUM_first_pool_1_01_01-2xIT_2xHCD-1h-R1/scripts/msp2tsv.bsub)
#echo Submitted msp2tsv job with ID: $jid_msp2tsv


# submit interpolate job
#jid_interpolate=$(get_jobid bsub < /scratch1/fs1/d.goldfarb/Backpack/ProteomeTools/Part1/01625b_GA1-TUM_first_pool_1_01_01-2xIT_2xHCD-1h-R1/scripts/interpolate.bsub)
#echo Submitted interpolate job with ID: $jid_interpolate
