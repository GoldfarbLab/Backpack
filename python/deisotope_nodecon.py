    ...
    for base_ion in base_ion2isotope:
        ...
        if base_ion not in ambig_annots:
            ...
            #        masks.append(1) # this was masked outside the scan range already
                ...
                #print(percent_theo_observed, sim, sim_threshold)
